class DeCraftFridge extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Dismount";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Skyline_Fridge");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Skyline_Kit_Fridge");//add results here
