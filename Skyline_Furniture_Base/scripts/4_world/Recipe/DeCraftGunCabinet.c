class DeCraftGunCabinet extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Dismount";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Skyline_Gun_Cabinet");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Skyline_Kit_Gun_Cabinet");//add results here
