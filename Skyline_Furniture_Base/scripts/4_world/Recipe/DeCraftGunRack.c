class DeCraftGunRack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Dismount";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Skyline_Gun_Rack");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Skyline_Kit_Gun_Rack");//add results here
