class DeCraftStorageBox extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Dismount";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Skyline_StorageBox");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Skyline_Kit_StorageBox");//add results here
